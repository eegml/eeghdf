...
ch = 15
plt.hist(
    eegf2.phys_signals[ch, 4000:6000],
    bins="auto",
    label=eegf2.file_name + eegf2.electrode_labels[ch],
)
plt.hist(
    eegf.phys_signals[ch, 4000:6000],
    bins="auto",
    label=eegf.file_name + eegf.electrode_labels[ch],
)
plt.hist(
    eegf3.phys_signals[ch, 4000:6000] - 1000,
    bins="auto",
    label=eegf3.file_name + eegf3.electrode_labels[ch] + " shifted -1000",
)
plt.legend()
