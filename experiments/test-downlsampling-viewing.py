...
# %% nbpresent={"id": "b1c64b00-9ee7-4251-955d-880979dfed41"}
# ls
...
# %% nbpresent={"id": "6a438f86-df80-4c44-90ce-ab948d754c2a"}
list(hf.keys())

# %% nbpresent={"id": "ce900c93-758a-43f5-ab6d-d5c27eba0e91"}
frec = hf["frecord200Hz"]

# %% nbpresent={"id": "89e457e1-9185-42e5-9c69-aab26c6acba5"}
dict(frec.items())
